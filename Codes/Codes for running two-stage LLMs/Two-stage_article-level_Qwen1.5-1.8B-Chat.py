...
model_path = "/root/autodl-tmp/Two-stage_article-level_Qwen1.5-1.8B-Chat"
...
years=["Two-stage_act-level_Qwen1.5-1.8B-Chat"]
for year in years:
  print("Year",year)
  ...
  for i in range(len(Questions)):
    ...
    print("No Question",i+1,"\n","Right_Answer:",Answers[i],"\nTwo-stage_article-level_Qwen1.5-1.8B-Chat:",answer0.strip().replace("\n",""))
    
    df = pd.concat([df, df2], axis=0)

  save_df_to_excel(df, "Two-stage_article-level_Qwen1.5-1.8B-Chat.xlsx", "sheet1")