...
model_path = "/root/autodl-tmp/Two-stage_article-level_Baichuan2-13B-Chat"
...
years=["Two-stage_act-level_Baichuan2-13B-Chat"]
for year in years:
  print("Year",year)
  ...
  for i in range(len(Questions)):
    ...
    print("No Question",i+1,"\n","Right_Answer:",Answers[i],"\nAnswer_from_Two-stage_article-level_Baichuan2-13B-Chat:",answer0)

    df = pd.concat([df, df2], axis=0)
  save_df_to_excel(df, "Two-stage_article-level_Baichuan2-13B-Chat.xlsx", "sheet1")
