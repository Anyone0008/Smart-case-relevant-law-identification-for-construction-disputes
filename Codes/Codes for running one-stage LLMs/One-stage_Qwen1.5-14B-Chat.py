...
model_path = "/root/autodl-tmp/One-stage_Qwen1.5-14B-Chat"
...
for year in years:
  ...
  for i in range(len(Questions)):
    ...
    print("No Question",i+1,"\n","Right_Answer:",Answers[i],"\nAnswer_from_One-stage_Qwen1.5-14B-Chat:",answer0.strip().replace("\n",""))
    
    df = pd.concat([df, df2], axis=0)

  save_df_to_excel(df, "One-stage_Qwen1.5-14B-Chat.xlsx", "sheet1")